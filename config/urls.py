...
urlpatterns = [
    ...
    #customer
    path('customer/register', views.CustomerRegisterView),
    path('customer/confirm/', views.CustomerConfirmView),
    path('customer/complete/', views.CustomerCompleteView),
    ...
    #Cart/remove/ページにアクセスした場合、Viewsのremove_from_cartを返す

    path('cart/add/', views.AddCartView.as_view()),
    #Cart/add/ページにアクセスした場合、ViewsのAddCartViewを返す

    path('cart/', views.CartListView.as_view()),
    #カートページにアクセスした場合、ViewsのCartListViewを返す
